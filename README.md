...
Recently I’ve been developing a cross-platform mobile app using Flutter and Supabase, building features like authentication, messaging, admin tools, and a digital marketplace. Alongside this, I work on trading analytics tools, charting systems, financial scanners, and Discord integrations.

In startup environments I tend to work across the whole stack, from database design and backend architecture to UI development and data visualization.
